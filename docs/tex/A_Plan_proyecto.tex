...
En la reunión del \textit{sprint} 13 estuvimos viendo algunos errores pequeños vistos por los tutores.
También se vieron los cambios realizados y se comentó alguna cosa que podía añadir a la documentación.
\end{itemize}


\subsubsection{\textit{Sprint} 14: X}
...
Para la tarea <<X>> se dio una estimación de 

\item\textbf{Revisión del \textit{sprint}}

En la reunión del \textit{sprint} 14.............
\end{itemize}
